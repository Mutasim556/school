  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-7">
            <div class="card">
                <div class="div-header mt-3">
                    <h4 class="card-title text-center">{{ env('APP_NAME') }} Content Manger</h4>
                    <h4 class="card-title text-right mr-3"></h4>
                </div>
                <div class="card-body">
                    <form class="theme-form" id="school_content_form" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            
                            <div class="from-group col-md-12 mt-2">
                                <label for="" class="labelcolor"><strong>School Name</strong></label>
                                <input type="text" name="school_name" class="form-control" value="{{ $school_contents->school_name }}">
                            </div>
                            <div class="from-group col-md-4 mt-2">
                                <label for="" class="labelcolor"><strong>School EIIN</strong></label>
                                <input type="text" name="school_eiin" class="form-control" value="{{ $school_contents->school_eiin }}">
                            </div>
                            <div class="from-group col-md-4 mt-2">
                                <label for="" class="labelcolor"><strong>School Founded</strong></label>
                                <input type="date" name="school_founded" class="form-control" value="{{ $school_contents->school_founded }}">
                            </div>
                            <div class="from-group col-md-4 mt-2" id="upload_image">
                                <label class="labelcolor" for=""><strong>School Logo</strong></label>
                                <input class="form-control" type="file" id="images1" name="image">
                            </div>
                            <div class="col-md-4 text-center mt-3" id="upload-demo-div1"><div id="upload-demo1"></div></div>
                            <div class="col-md-4 text-center mt-3" >
                                <label class="labelcolor" for=""><strong>Previous Logo</strong></label><br>
                                <img src="{{ asset($school_contents->school_logo) }}" alt="">
                            </div>
                            <div class="from-group col-md-12 mt-3">
                                <button class="btn btn-success btn-square" style="float: right" id="school_content_buuton" type="submit" >UPDATE INFORMATION</button>
                            </div>
                        </div>
                    </form>
                </div>
